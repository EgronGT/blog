...
INSERT INTO DependencyData VALUES	("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "{8AD6DAF4-C0B6-4F58-91B1-B74B7CD58008}", "upgrade", "", "", "")
INSERT INTO DependencyData VALUES	("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "{554A7BA9-8879-496E-BC3D-93650613DDE5}", "upgrade", "", "", "")
INSERT INTO DependencyData VALUES	("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "{BB22C138-E41C-4B24-88D4-D3E886519FF1}", "upgrade", "", "", "")
INSERT INTO DependencyData VALUES	("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "{156C1AE8-04F1-4274-BF80-D002814805BB}", "upgrade", "", "", "")
INSERT INTO DependencyData VALUES	("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "{1F955A4A-F365-4379-AEE2-B7C83E1AA883}", "patch", "Photoshop", "Adobe Photoshop CS6 Support", "")
INSERT INTO PayloadData VALUES("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "0" , "ValidationInfo", '<ValidationInfo payloadID="{6D7CC1C2-62A9-4764-9536-CDC175C7B054}"><File><InstallPath>[AdobeCommon]\Adobe Photoshop CS6\32 bit Photoshop dlls\AlignmentLib.dll</InstallPath><SignatureType>DigitalSignature</SignatureType><SignatureInfo>Adobe Systems Incorporated{|}VeriSign Class 3 Code Signing 2010 CA{|}VeriSign Class 3 Public Primary Certification Authority - G5</SignatureInfo></File><File><InstallPath>[AdobeCommon]\Adobe Photoshop CS6\32 bit Photoshop dlls\libifcoremd.dll</InstallPath><SignatureType>DigitalSignature</SignatureType><SignatureInfo>Adobe Systems Incorporated{|}VeriSign Class 3 Code Signing 2010 CA{|}VeriSign Class 3 Public Primary Certification Authority - G5</SignatureInfo></File></ValidationInfo>')
INSERT INTO PayloadData VALUES("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "0" , "ValidationSig", "")
INSERT INTO Payloads VALUES	("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "Photoshop", "Adobe Photoshop CS6 Support_13.0.1.3_AdobePhotoshop13-Support", "13.0.1.3", "patch")
INSERT INTO PayloadData VALUES("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "0" , "PayloadInfo", '<PayloadInfo version="6.0.98.0"><BuildInfo>
    <Property name="Created">2013-10-29 16:16:57.551000</Property>
    <Property name="TargetName">AdobePhotoshop13-Support-291013161657</Property>
    <Property name="ProcessorFamily">All</Property>
  </BuildInfo><InstallerProperties>
    <Property name="payloadType">SQLite</Property>
    <Property name="AdobeCode">{6D7CC1C2-62A9-4764-9536-CDC175C7B054}</Property>
    <Property name="ProductName">Adobe Photoshop CS6 Support</Property>
    ...
    <ProductInfo>
      ...
      <ProductName>Adobe Photoshop CS6 Support_13.0.1.3_AdobePhotoshop13-Support</ProductName>
      <ProductVersion>13.0.1.3</ProductVersion>
    </ProductInfo>
  </Satisfies><Upgrades>
    <AdobeCode>{8AD6DAF4-C0B6-4F58-91B1-B74B7CD58008}</AdobeCode>
    <AdobeCode>{554A7BA9-8879-496E-BC3D-93650613DDE5}</AdobeCode>
    <AdobeCode>{BB22C138-E41C-4B24-88D4-D3E886519FF1}</AdobeCode>
    <AdobeCode>{156C1AE8-04F1-4274-BF80-D002814805BB}</AdobeCode>
  </Upgrades><Channel enable="1" id="AdobePhotoshopCS6Support-13.0">
        <DisplayName>Adobe Photoshop CS6 Support</DisplayName>
    ...
    <ParentProductInfo>
      <Family>Photoshop</Family>
      <ProductName>Adobe Photoshop CS6 Support</ProductName>
      <AdobeCode>{1F955A4A-F365-4379-AEE2-B7C83E1AA883}</AdobeCode>
    </ParentProductInfo>
  </Extends><InstallDestinationMetadata relocatableSize="9421" sysDriveSize="9600501"><Destination>
      <Root>[INSTALLDIR]</Root>
      <TotalSize>9421</TotalSize>
      <MaxPathComponent>/Adobe/AdobePatchFiles/{6D7CC1C2-62A9-4764-9536-CDC175C7B054}\3c02345eb9a73756a3a5e495cc096687.rtp</MaxPathComponent>
    </Destination>
    <Destination>
      <Root>[AdobeCommon]</Root>
      <TotalSize>9600501</TotalSize>
      <MaxPathComponent>/Adobe Photoshop CS6/32 bit Photoshop dlls\AlignmentLib.dll</MaxPathComponent>
    </Destination>
    <Assets>
      <Asset flag="0" name="Assets2_1" size="9600501"/>
      <Asset flag="1" name="Assets1_1" size="9421"/>
    </Assets>
    ...
    <DisplayName>
      <Value lang="ar_AE">Adobe Photoshop CS6 Support</Value>
      <Value lang="be_BY">Adobe Photoshop CS6 Support</Value>
      <Value lang="bg_BG">Adobe Photoshop CS6 Support</Value>
      <Value lang="ca_ES">Adobe Photoshop CS6 Support</Value>
      <Value lang="cs_CZ">Adobe Photoshop CS6 Support</Value>
      <Value lang="da_DK">Adobe Photoshop CS6 Support</Value>
      <Value lang="de_DE">Adobe Photoshop CS6 Support</Value>
      <Value lang="el_GR">Adobe Photoshop CS6 Support</Value>
      <Value lang="en_GB">Adobe Photoshop CS6 Support</Value>
      <Value lang="en_MX">Adobe Photoshop CS6 Support</Value>
      <Value lang="en_US">Adobe Photoshop CS6 Support</Value>
      <Value lang="en_XC">Adobe Photoshop CS6 Support</Value>
      <Value lang="en_XM">Adobe Photoshop CS6 Support</Value>
      <Value lang="es_ES">Adobe Photoshop CS6 Support</Value>
      <Value lang="es_MX">Adobe Photoshop CS6 Support</Value>
      <Value lang="es_QM">Adobe Photoshop CS6 Support</Value>
      <Value lang="et_EE">Adobe Photoshop CS6 Support</Value>
      <Value lang="fi_FI">Adobe Photoshop CS6 Support</Value>
      <Value lang="fr_CA">Adobe Photoshop CS6 Support</Value>
      <Value lang="fr_FR">Adobe Photoshop CS6 Support</Value>
      <Value lang="fr_MX">Adobe Photoshop CS6 Support</Value>
      <Value lang="fr_XM">Adobe Photoshop CS6 Support</Value>
      <Value lang="he_IL">Adobe Photoshop CS6 Support</Value>
      <Value lang="hi_IN">Adobe Photoshop CS6 Support</Value>
      <Value lang="hr_HR">Adobe Photoshop CS6 Support</Value>
      <Value lang="hu_HU">Adobe Photoshop CS6 Support</Value>
      <Value lang="is_IS">Adobe Photoshop CS6 Support</Value>
      <Value lang="it_IT">Adobe Photoshop CS6 Support</Value>
      <Value lang="ja_JP">Adobe Photoshop CS6 Support</Value>
      <Value lang="ko_KR">Adobe Photoshop CS6 Support</Value>
      <Value lang="lt_LT">Adobe Photoshop CS6 Support</Value>
      <Value lang="lv_LV">Adobe Photoshop CS6 Support</Value>
      <Value lang="mk_MK">Adobe Photoshop CS6 Support</Value>
      <Value lang="nb_NO">Adobe Photoshop CS6 Support</Value>
      <Value lang="nl_NL">Adobe Photoshop CS6 Support</Value>
      <Value lang="nn_NO">Adobe Photoshop CS6 Support</Value>
      <Value lang="no_NO">Adobe Photoshop CS6 Support</Value>
      <Value lang="pl_PL">Adobe Photoshop CS6 Support</Value>
      <Value lang="pt_BR">Adobe Photoshop CS6 Support</Value>
      <Value lang="ro_RO">Adobe Photoshop CS6 Support</Value>
      <Value lang="ru_RU">Adobe Photoshop CS6 Support</Value>
      <Value lang="sh_YU">Adobe Photoshop CS6 Support</Value>
      <Value lang="sk_SK">Adobe Photoshop CS6 Support</Value>
      <Value lang="sl_SI">Adobe Photoshop CS6 Support</Value>
      <Value lang="sq_AL">Adobe Photoshop CS6 Support</Value>
      <Value lang="sv_SE">Adobe Photoshop CS6 Support</Value>
      <Value lang="th_TH">Adobe Photoshop CS6 Support</Value>
      <Value lang="tr_TR">Adobe Photoshop CS6 Support</Value>
      <Value lang="uk_UA">Adobe Photoshop CS6 Support</Value>
      <Value lang="vi_VN">Adobe Photoshop CS6 Support</Value>
      <Value lang="zh_CN">Adobe Photoshop CS6 Support</Value>
      <Value lang="zh_TW">Adobe Photoshop CS6 Support</Value>
      <Value lang="en_AE">Adobe Photoshop CS6 Support</Value>
      <Value lang="en_IL">Adobe Photoshop CS6 Support</Value>
      <Value lang="fr_MA">Adobe Photoshop CS6 Support</Value>
    </DisplayName>
  </AddRemoveInfo><UserPreferences>0</UserPreferences></PayloadInfo>')
INSERT INTO PayloadData VALUES("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "0" , "WorkflowVersion", "CS6")
INSERT INTO PayloadData VALUES("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "0" , "DEVersion", "6.0")
INSERT INTO PayloadData VALUES("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "0", "ChannelID", "AdobePhotoshopCS6Support-13.0")
INSERT INTO PayloadData VALUES("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "0", "ChannelInfo", '<Channel enable="1" id="AdobePhotoshopCS6Support-13.0">
        <DisplayName>Adobe Photoshop CS6 Support</DisplayName>
      </Channel>')
INSERT INTO PayloadData VALUES("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "0", "UpdateID", "13.0.1.3")
INSERT INTO PayloadData VALUES("{6D7CC1C2-62A9-4764-9536-CDC175C7B054}", "0", "UpdateInfo", '<Update id="13.0.1.3">
